...
Role prompts are limited to six non-empty lines; the loader rejects longer ones. Read-only roles (explorer, reviewer, qa-mutation) render with restricted tools.
