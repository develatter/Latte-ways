...
Assess durable semantic impact; use the core memory workflow for reviewed memory commits when required.
Never author generated indexes or launch provider-specific agents through the core.
Run focused checks and create atomic commits with the required trailers.
